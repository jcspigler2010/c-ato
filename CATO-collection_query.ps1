...
# $cred = New-Object System.Management.Automation.PSCredential ("$ENV:SrvUser", $SrvPassword)
# Invoke-Command -ComputerName node1 -Credential $Credential -ScriptBlock {Get-Process}

$SrvPassword = ConvertTo-SecureString $arg3 -AsPlainText -Force
$cred = New-Object System.Management.Automation.PSCredential ($arg2, $SrvPassword)
Invoke-Command -ComputerName node1 -Credential $cred -ScriptBlock {Get-Process}
